$(function(){
    ...
    function initNumXY(){
        ...
        $(".dot").each(function(index, el) {
            $(this).css({
                "left":70+Math.sin((ahd*index))*radius,
                "top":70+Math.cos((ahd*index))*radius
            });
        });
        // 2、刻钟设置
        for(var i = 0; i < 60; i++) {
    ...
    var hour_line = document.getElementById("hour_line"),
        ...
        hour_time_1=document.getElementById("hour_time_1"),
        minute_time_1=document.getElementById("minute_time_1");
    ...
    function setTime(){
        ...
        hour_time_1.innerHTML="<strong>:</strong>";
        minute_time.innerHTML = minutes >=10 ? minutes : "0"+minutes;
        minute_time_1.innerHTML="<strong>:</strong>";
